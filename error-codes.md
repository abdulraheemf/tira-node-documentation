...
| `TIRA016` | Invalid request signature | Your digital signature is invalid. Check that your private PFX file (`pfx_path`) and passphrase (`pfx_passphrase`) are correct. See [Signing & Verification](/signing-verification). |
