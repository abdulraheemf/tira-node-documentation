...
| `TIRA016` | Sahihi ya ombi si sahihi | Sahihi yako ya kidijitali si sahihi. Angalia faili yako ya PFX ya faragha (`pfx_path`) na nywila (`pfx_passphrase`). Tazama [Usainiaji na Uthibitishaji](/sw/signing-verification). |
