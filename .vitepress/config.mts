        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: "Cover Note Verification", link: "/covernote-verification" },
              { text: "Reinsurance", link: "/reinsurance" },
              { text: "Policy", link: "/policy" },
              { text: "Claim Notification", link: "/claim-notification" },
              { text: "Claim Intimation", link: "/claim-intimation" },
              { text: "Claim Assessment", link: "/claim-assessment" },
              { text: "Discharge Voucher", link: "/discharge-voucher" },
              { text: "Claim Payment", link: "/claim-payment" },
              { text: "Claim Rejection", link: "/claim-rejection" },
            ],
          },
        ],
      },
        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: "Uthibitishaji wa Covernote", link: "/sw/covernote-verification" },
              { text: "Bima ya Kurudisha", link: "/sw/reinsurance" },
              { text: "Sera", link: "/sw/policy" },
              { text: "Taarifa ya Madai", link: "/sw/claim-notification" },
              { text: "Madai ya Awali", link: "/sw/claim-intimation" },
              { text: "Tathmini ya Madai", link: "/sw/claim-assessment" },
              { text: "Hati ya Malipo", link: "/sw/discharge-voucher" },
              { text: "Malipo ya Madai", link: "/sw/claim-payment" },
              { text: "Kukataliwa kwa Madai", link: "/sw/claim-rejection" },
            ],
          },
        ],
